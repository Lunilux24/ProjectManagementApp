        ...
        <div className="list row">
                <div className="col-12 mb-3 d-flex flex-column flex-md-row align-items-start list-header">
                    ...
                    <div className="input-group-append">
                        <button className="btn btn-outline-secondary" type="button" onClick={searchTitleFunc}>
                            Search
                        </button>
                    </div>
                </div>
                <div className="d-flex align-items-center mt-2 mt-md-0">
                    <select className="form-control mr-2" value={sortKey} onChange={(e) => setSortKey(e.target.value)}>
                        <option value="name">Title</option>
                        <option value="status">Status</option>
                    </select>
                    <button className="btn btn-outline-primary" type="button" onClick={toggleSortOrder}>
                ...
                {currentProject ? (
                    <div className="detail-card">
                        ...
                        <div className="detail-item">
                            ...
                            {currentProject.created_at ? new Date(currentProject.created_at).toLocaleString() : ""}
                        </div>
                        <div className="detail-item">
                            <label>
                        ...
                        <div className="detail-item">
                            <Link to={"/projects/" + currentProject.id} className="btn btn-primary">
                                Edit
                            </Link>
                        </div>
                    </div>
